  ...
  return (
    <div className={styles.blurBackground} onClick={toggleHelp}>
      <div className={styles.container} onClick={(e) => e.stopPropagation()}>
        <button onClick={toggleHelp} className={styles.closeButton} aria-label="close help">x</button>
        <div className={styles.row}>
          <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 14 14"><path fill="black" stroke="black" strokeLinecap="round" strokeLinejoin="round" d="M1.436 12.33a1.14 1.14 0 0 0 .63 1a1.24 1.24 0 0 0 1.22 0l8.65-5.35a1.11 1.11 0 0 0 0-2L3.286.67a1.24 1.24 0 0 0-1.22 0a1.14 1.14 0 0 0-.63 1z"/></svg>
        ...
        <div className={styles.row}>
          ...
          <p className={styles.rowText}>Tweet your scores to me! <a href="https://x.com/chrstnctns" target="_blank" rel="noreferrer">@chrstnctns</a></p>
        </div>
      </div>
    </div>
  )
